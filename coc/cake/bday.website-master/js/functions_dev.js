...
function timeElapse(startDate, endDate) {
    ...
    function updateTime() {
        ...
        if (current < end) {
            ...
            seconds = (end - current) / 1000;
        } else {
            // Calculate elapsed time after end date
            seconds = (current - end) / 1000;
        }
        ...
        var result;
        if (current < end) {
            result = `<span class="digit">${days}</span> days <span class="digit">${minutes}</span> minutes <span class="digit">${seconds}</span> seconds`;
        } else {
            result = `<span class="digit">-${days}</span> days <span class="digit">${minutes}</span> minutes <span class="digit">${seconds}</span> seconds`;
        }
...
var startDate = "2024-12-22";
var endDate = "2124-12-22";
timeElapse(startDate, endDate);
